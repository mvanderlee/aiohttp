...
DEF DEFAULT_MAX_LINE_SIZE = int(getenv('AIOHTTP_DEFAULT_MAX_LINE_SIZE', 8190))
DEF DEFAULT_MAX_HEADERS = int(getenv('AIOHTTP_DEFAULT_MAX_HEADERS', 32768))
DEF DEFAULT_MAX_FIELD_SIZE = int(getenv('AIOHTTP_DEFAULT_MAX_FIELD_SIZE', 65536))
